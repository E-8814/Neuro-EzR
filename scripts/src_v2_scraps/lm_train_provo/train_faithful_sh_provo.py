"""
Training for model_llama_faithful_sh on Provo corpus.

Same as train_faithful_provo.py but with a learned skip head.
...
Usage:
  python3 -u src_v2/lm_train_provo/train_faithful_sh_provo.py
  python3 -u src_v2/lm_train_provo/train_faithful_sh_provo.py --model TinyLlama/TinyLlama-1.1B-Chat-v1.0
"""
...
L1_MAX = 400.0
L1_MIN = 60.0
SKIP_TARGET = 0.35       # Provo has lower skip rate than GECO
...
def train(
    ...
    save_dir="../../checkpoints/faithful_sh/provo_llama",
    log_path="../../logs/train_faithful_sh_provo.log",
    seed=42,
    ...
    print("\n" + "=" * 90)
    print(f"Training FAITHFUL+SH model on Provo")
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(os.path.dirname(__file__), "..", "..", "checkpoints", "faithful_sh", f"provo_{model_short}")
    log_path = os.path.join(os.path.dirname(__file__), "..", "..", "logs", f"train_faithful_sh_provo.log")
