...
def train(
    ...
    save_dir="../../checkpoints/v2/geco_llama",
    seed=42,
...
if __name__ == "__main__":
    ...
    if args.ablation:
        save_dir = os.path.join(os.path.dirname(__file__), "..", "..",
                                "checkpoints", "v2", f"geco_{model_short}_ablation_{args.ablation}")
    else:
        save_dir = os.path.join(os.path.dirname(__file__), "..", "..", "checkpoints", "v2", f"geco_{model_short}")
