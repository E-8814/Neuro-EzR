"""
Training for model_gpt2_faithful_sh on GECO corpus.

Identical to train_faithful_sh_geco.py but imports NeuralEZReaderGPT2
instead of the LLaMA variant. All hyperparameters, loss, and evaluation
are the same.

Usage:
  python3 -u src_v2/lm_train/train_gpt2_faithful_sh_geco.py
  python3 -u src_v2/lm_train/train_gpt2_faithful_sh_geco.py --model gpt2-medium
  python3 -u src_v2/lm_train/train_gpt2_faithful_sh_geco.py --model gpt2-large
"""
...
from model_gpt2_faithful_sh import NeuralEZReaderGPT2
...
def print_model_params(model):
    ...
    print(f"    skip_head                 = learned (from GPT-2 repr)")
...
def train(
    ...
    save_dir="../../checkpoints/gpt2_faithful_sh/geco",
    log_path="../../logs/train_gpt2_faithful_sh_geco.log",
    seed=42,
    ...
    print("\n" + "=" * 90)
    print(f"Training GPT-2 FAITHFUL+SH model on GECO")
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(os.path.dirname(__file__), "..", "..", "checkpoints", "gpt2_faithful_sh", f"geco_{model_short}")
    log_path = os.path.join(os.path.dirname(__file__), "..", "..", "logs", f"train_gpt2_faithful_sh_geco_{model_short}.log")
