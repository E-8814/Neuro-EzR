"""
Neural EZ Reader — Faithful to Reichle et al. + learned skip head.

Same as model_llama_faithful.py except skip_prob comes from a learned
head over LLaMA representations instead of raw predictability.
