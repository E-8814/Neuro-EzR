...
Shows how model parameters can be changed.
"""
...
#we check what model parameters there
print(sim.model_parameters)

# we modify a value of one parameter - alpha1
sim.model_parameters["alpha1"] = 70
