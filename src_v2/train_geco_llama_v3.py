...
def train(
    ...
    save_dir="../checkpoints_v3/geco_llama",
    seed=42,
...
if __name__ == "__main__":
    ...
    if args.ablation:
        save_dir = os.path.join(os.path.dirname(__file__), "..",
                                f"checkpoints_v3/geco_{model_short}_ablation_{args.ablation}")
    else:
        save_dir = os.path.join(os.path.dirname(__file__), "..", f"checkpoints_v3/geco_{model_short}")
