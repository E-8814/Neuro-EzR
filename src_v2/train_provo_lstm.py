"""
Supervised training for the Differentiable Neural EZ Reader v2 (LSTM).
...
def compute_loss(pred, human_trt, human_ffd, human_gaze, human_skip):
    ...
    Combined loss with 4 components + 2 regularizers:
      ...
      - MSE on gaze duration (forces L2 to be meaningful)
...
def train(
    ...
    num_epochs=100,
    lr=1e-3,
    save_dir="../checkpoints_v2/provo_lstm",
    seed=42,
):
    ...
    print("\n" + "=" * 90)
    print("Training (Differentiable EZ Reader v2) - ALL per-participant data")
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(os.path.dirname(__file__), "..", "checkpoints_v2/provo_lstm")
