...
def main():
    ...
    lstm_checkpoint = os.path.join(os.path.dirname(__file__), '..', '..', 'checkpoints', 'v2', 'provo_lstm', 'best_model_lstm.pt')
    bert_checkpoint = os.path.join(os.path.dirname(__file__), '..', '..', 'checkpoints', 'v2', 'provo_bert', 'best_model_bert.pt')
