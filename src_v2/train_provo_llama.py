"""
Supervised training for the LLaMA-based Differentiable Neural EZ Reader v2 on Provo Corpus.
...
Usage:
  ...
  python3 -u src_v2/train_provo_llama.py

  # Custom model (any causal HuggingFace model):
  python3 -u src_v2/train_provo_llama.py --model TinyLlama/TinyLlama-1.1B-Chat-v1.0

  # Adjust freeze layers:
  python3 -u src_v2/train_provo_llama.py --freeze 12
"""
...
def train(
    ...
    save_dir="../checkpoints_v2/provo_llama",
    seed=42,
    ...
    # Split raw data by text for training (70/15/15)
    ...
    print("\n" + "=" * 90)
    print(f"Training (LLaMA + Differentiable EZ Reader v2) on Provo Corpus [GPU-optimized]")
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(os.path.dirname(__file__), "..", f"checkpoints_v2/provo_{model_short}")
