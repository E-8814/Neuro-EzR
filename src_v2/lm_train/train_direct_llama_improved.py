...
def train(data_dir="../data", num_epochs=30, lm_lr=5e-5, head_lr=2e-4,
          batch_size=4, accumulation_steps=4, save_dir="../../checkpoints/v2/geco_direct_llama_improved",
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join(os.path.dirname(__file__), "..", "..", "checkpoints", "v2", f"geco_direct_{model_short}_improved")
