...
FIGURE_MAP = [
    ...
    ("exp02_randinit_recovery/results/plot_recovery.pdf", "fig2_param_recovery.pdf"),
    ("exp03_lesion_study/results/plot_lesion.pdf",        "fig3_lesion.pdf"),
    ("exp05_ceiling_curve_provo/results/plot_ceiling_curve.pdf", "fig4_ceiling_curve.pdf"),
